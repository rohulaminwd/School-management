...
const BannerTop = () => {
    return (
        <div className='flex items-center px-2 sm:px-4 justify-center md:mb-0 py-10 md:pt-8'>
            <div className="w-full md:w-[80%] flex justify-between items-center lg:-mt-20 bg-gradient-to-r from-blue-100 to-green-100 shadow-md p-2 md:p-4 -bottom-20 rounded-xl">
                <div className="">
