...
const ReviewCard = ({review}) => {
    ...
    return (
        <div className='p-3' data-aos="zoom-in-down" data-aos-delay="100" data-aos-duration="800">
            <div className="card p-3 bg-base-100 text-start h-full border hover:border-blue-900 hover:shadow-md hover:translate-y-[-5px] transition border-blue-200">
                <div className='text-3xl font-bold text-cyan-900'><ImQuotesLeft /></div>
                <p className='my-2'>{description.slice(0, 80)}...</p>
                <div className="flex items-center justify-between">
                    <div className="">
                        <h2 className="text-xl text-cyan-800 font-bold my-0">{name}</h2>
